 ...
 * Copyright 2020 - Cristian Vincenzini 
 *
 */
...
bool check_bit(unsigned char c, int pos)
{
	...
	return is_bit_at_pos_on ? true : false;
}
...
{
	/* la funcion memset recibe el buffer y rellena sus primeros n bytes con espacios 
	 * en este caso los n bytes coinciden con el tamanio del buffer 
	 */
